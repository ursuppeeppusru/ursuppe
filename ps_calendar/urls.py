...
from .views import calendar_submission_create, event_list, event_list_past, event_list_upcoming, event_list_closing_soon, event_list_openings_this_week, event_map, json_event_list, event_detail
...
urlpatterns = [
    ...
    path('openings', event_list_openings_this_week, name='event_list_openings_this_week'),
