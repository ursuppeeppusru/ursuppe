...
/* event form one-day event toggle */
// Only for Create Event page
if(document.body.classList.contains('event-form')) {
    document.addEventListener('DOMContentLoaded', function () {
        const oneDayEventCheckbox = document.querySelector('#id_one_day_event');
        const exhibitionOpeningField = document.querySelector('#id_exhibition_opening').closest('p');
        const exhibitionEndField = document.querySelector('#id_exhibition_end').closest('p');
        const openingHoursField = document.querySelector('#id_opening_hours').closest('p');

        function toggleFields() {
          if (oneDayEventCheckbox.checked) {
            exhibitionOpeningField.style.display = 'none';
            exhibitionEndField.style.display = 'none';
            openingHoursField.style.display = 'none';
          } else {
            exhibitionOpeningField.style.display = 'block';
            exhibitionEndField.style.display = 'block';
            openingHoursField.style.display = 'block';
          }
        }

        oneDayEventCheckbox.addEventListener('change', toggleFields);
