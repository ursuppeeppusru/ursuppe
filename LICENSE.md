// Copyright (C) 2024 ursuppe <ursuppe@kollektiv.email>
// This file is part of ursuppe.
//
// ursuppe is non-violent software: you can use, redistribute,
// and/or modify it under the terms of the CNPLv7+ as found
// in the LICENSE file in the source code root directory or
// at <https://git.pixie.town/thufie/npl-builder>.
//
// ursuppe comes with ABSOLUTELY NO WARRANTY, to the extent
