...
from .views import exhibition_submission_create, exhibition_list, exhibition_list_highlights, exhibition_list_year, exhibition_submission_detail

urlpatterns = [
    path('create', exhibition_submission_create, name='exhibition_submission_create'),
    path('', exhibition_list, name='exhibition_list'),
    path('highlights/', exhibition_list_highlights, name='exhibition_list_highlights'),
